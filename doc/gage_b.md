...
| Q20L60   |     250 | 439991631 | 1943129 |
| Q20L90   |     250 | 435656688 | 1884831 |
| Q25L60   |     250 | 414752350 | 1875395 |
| Q25L90   |     250 | 409896636 | 1810052 |
...
perl -e '
    ...
    | parallel -k --no-run-if-empty -j 3 "
        ...
        bash ~/Scripts/cpan/App-Anchr/share/sr_stat.sh 1 2_illumina/{} ${REAL_G}
    " >> stat1.md
...
|:-------|--------:|------:|--------:|-------:|---------:|--------:|------:|------:|------:|---------:|----------:|
| Q20L60 | 440.11M |  81.0 | 372.42M |   68.6 |  15.381% |     224 | "127" | 5.43M | 5.36M |     0.99 | 0:01'51'' |
| Q20L90 | 435.82M |  80.2 | 369.14M |   67.9 |  15.300% |     228 | "127" | 5.43M | 5.36M |     0.99 | 0:01'44'' |
| Q25L60 | 414.91M |  76.4 | 372.18M |   68.5 |  10.299% |     218 | "127" | 5.43M | 5.34M |     0.98 | 0:01'37'' |
| Q25L90 |  410.1M |  75.5 | 368.08M |   67.8 |  10.246% |     224 | "127" | 5.43M | 5.34M |     0.98 | 0:01'33'' |
| Q30L60 | 372.08M |  68.5 | 348.42M |   64.1 |   6.360% |     210 | "121" | 5.43M | 5.34M |     0.98 | 0:01'22'' |
| Q30L90 |  366.6M |  67.5 |  343.3M |   63.2 |   6.356% |     216 | "127" | 5.43M | 5.34M |     0.98 | 0:01'20'' |
...
perl -e '
    ...
    | parallel --no-run-if-empty -j 1 "
        ...
        anchr kunitigs \
            ${HOME}/data/anchr/${BASE_NAME}/2_illumina/{}/pe.cor.fa \
            ${HOME}/data/anchr/${BASE_NAME}/2_illumina/{}/environment.json \
            -p 16 \
            --kmer 31,41,51,61,71,81,101,121,59,85,91 \
            -o kunitigs.sh
        bash kunitigs.sh
...
perl -e '
    ...
    | parallel -k --no-run-if-empty -j 6 "
        ...
        bash ~/Scripts/cpan/App-Anchr/share/sr_stat.sh 2 {} ${REAL_G}
    " >> stat2.md

cat stat2.md
```

| Name   |  SumCor | CovCor | N50SR |   Sum |   # | N50Anchor |   Sum |   # | N50Others |    Sum |  # |                                 Kmer |   RunTime |
|:-------|--------:|-------:|------:|------:|----:|----------:|------:|----:|----------:|-------:|---:|-------------------------------------:|----------:|
| Q20L60 | 372.42M |   68.6 | 22987 | 5.37M | 395 |     23039 | 5.35M | 363 |       789 | 23.68K | 32 | "31,41,51,59,61,71,81,85,91,101,121" | 0:01'14'' |
| Q20L90 | 369.14M |   67.9 | 23764 | 5.37M | 382 |     23783 | 5.35M | 351 |       783 | 22.96K | 31 | "31,41,51,59,61,71,81,85,91,101,121" | 0:01'13'' |
| Q25L60 | 372.18M |   68.5 | 42085 | 5.36M | 237 |     42085 | 5.34M | 215 |       735 | 14.96K | 22 | "31,41,51,59,61,71,81,85,91,101,121" | 0:01'16'' |
| Q25L90 | 368.08M |   67.8 | 41804 | 5.37M | 236 |     41804 | 5.33M | 213 |     27296 |    43K | 23 | "31,41,51,59,61,71,81,85,91,101,121" | 0:01'11'' |
| Q30L60 | 348.42M |   64.1 | 47486 | 5.41M | 218 |     47578 | 5.33M | 188 |     16154 | 83.03K | 30 | "31,41,51,59,61,71,81,85,91,101,121" | 0:01'11'' |
| Q30L90 |  343.3M |   63.2 | 45136 | 5.37M | 217 |     45136 | 5.33M | 191 |     16158 |  49.7K | 26 | "31,41,51,59,61,71,81,85,91,101,121" | 0:01'09'' |
...
| Genome       | 5224283 | 5432652 |   2 |
| Paralogs     |    2295 |  223889 | 103 |
| anchor.merge |   53284 | 5356240 | 173 |
| others.merge |   16204 |   64499 |   7 |
